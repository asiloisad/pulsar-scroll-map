...
module.exports = {
  ...
  /**
   * Consumes the hydrogen-next breakpoints service and toggles the hydrogen layer.
   ...
   */
  hydrogenLayer(hydrogenService) {
    this.hydrogenService = hydrogenService;
    if (atom.config.get("scroll-map.hydrogenLayer.state")) {
